...
def cubicNewtonFn(aVec,nOrder):
    ...
    # Find cubic roots
    recipRoots, tmpRoots = cubicRootsFn(coefMx)
...
coefMx = np.array([np.real(hMx[0,:]),d_x,d2_x/2,d3_x/6])
recipRoots, tmpRoots = cubicRootsFn(coefMx) 
...
# Update thetaVec
# Compute new cubic approximation
# Find the closest root
# Update rVec and thetaVec
